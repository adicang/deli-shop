...
<section class="container-fluid padding" id="regForm">
    <div class="container" dir="rtl">
        ...
        <div class="col-md-4 well text-center regForm">
          <h3>הירשמו והצטרפו ללקוחות שלנו!</h3>
                ...
                <div class="form-group">
                    <input class="form-control" type="number" name="phoneNum" required="" placeholder="מספר טלפון" id="phoneNum" />
                </div>
                <div class="form-group">
                ...
                <button class="btn btn-danger to-center" value="הירשם" onclick="addUserToDatabase()">הירשם</button>
