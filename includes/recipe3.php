...
<body>
    <div class="wrapper recepie">
            <header>
                ...
                <section>
                 <div class="container mt-5 mb-5" dir="rtl">
                        <div class="row recepieHead text-right">
                              
                                <div class="col">
                                    <h3>מתכון לסלט קינואה מלא חלבון </h3>
                                    <p>בתיאבון!</p>
                                  
                                </div>
                                <a href="recipes.php" class="float-left ">
                                    <span class="btn btn-danger">חזרה לרשימת מתכונים</span>
                                </a>
                            </div>
                 </div>
                </section>
        ...
        <section>
                        ...
                        <div class="container recepieCon mb-5" dir="rtl">
                            <div class="row">
                                  
                                <div class="col-md-6 col-12 text-right">
                                    <ul >
                                       <li class="font-weight-bold">מצרכים:</li>
                                       <li>כוס קינואה לבנה</li>
                                       <li>2 כוסות מים רותחים</li>
                                       <li>1/2 כפית מלח</li>
                                       <li>מניחים את הקינואה בקערה ושוטפים במים קרים, מרוקנים את הנוזלים דרך מסננת.</li>
                                       <li>מעבירים את הקינואה לסיר, מוסיפים מים רותחים ומלח וסוגרים מכסה.</li>
                                       <li>מבשלים על להבה נמוכה במשך 15 דקות, סוגרים להבה ומשאירים את המכסה ל-5 דקות נוספות.</li>
                                       <li>פותחים את גרגירי הקינואה בעזרת מזלג ומניחים בצד.</li>
                                       <li class="font-weight-bold">לרוטב:</li>
                                       <li>1/4 כוס שמן זית</li>
                                       <li>3 כפות חומץ בן יין</li>
                                       <li>כף חומץ תפוחים (אופציה)</li>
                                       <li>2 כפות דבש</li>
                                       <li>3 כפות מיץ לימון סחוט</li>
                                       <li class="font-weight-bold">לסלט:</li>
                                       <li>1/4 ראש קייל או כרוב או חסה חתוך</li>
                                       <li>סלסילת עגבניות שרי חצויות</li>
                                       <li>מלפפון גדול חתוך לקוביות</li>
                                       <li>בקערה בינונית מערבבים היטב את כל מצרכי הרוטב.</li>
                                       <li>בקערת הסלט מניחים חצי מכמות הקייל ועליו שופכים חצי מכמות הרוטב, מערבבים היטב ונותנים לעלים להתרכך כחצי דקה.</li>
                                       <li>מוסיפים את המלפפון, העגבניות והקינואה המוכנה, שופכים את הרוטב הנותר ומערבבים היטב</li>
                                    </ul>
                                </div>
                                <div class="col-md-6 col-12">
                                        <img class="img-fluid" src="../assets/img/kinoa.png" alt="אוסבוסקו טלה">
                                    </div>
                            </div>
                        </div>
