                        ...
                        <div class="container recepieCon mb-5" dir="rtl">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12 text-right">
                                    <ul >
                                        <li>4 נתחי פרגית שלמים שקונים אצל דודי</li>
                                        <li>מלח</li>
                                        <li>כורכום</li>
                                        <li>פפריקה מעושנת (או רגילה)</li>
                                        <li>שמן זית לטיגון</li>
                                        <p>
                                                אופן ההכנה
                                                •	מתחילים עם הבצל: פורסים את הבצל לפרוסות דקות. מעבירים לקערה קטנה, סוחטים עליו חצי לימון, מוסיפים 
                                                •	מניחים את נתחי הפרגית על משטח העבודה. מתבלים בנדיבות משני הצדדים במלח, כורכום ופפריקה. מעסים את התבלינים לתוך העוף.
                                                •	מחממים מחבת עם מעט שמן זית (עדיף נון סטיק). צולים את נתחי הפרגית 5-7 דקות מכל צד, עד שהן משחמים. בודקים עם סכין קטנה בחלק הכי עבה של אחד הנתחים אם היא באמת מוכנה מבפנים.
                                                •	בזמן שנתחי הפרגית על האש, קוצצים סלט ומכינים טחינה (אני לא הולכת להגיד לכם איך להכין סלט וטחינה, תכינו איך שאתם אוהבים).
                                                •	מרכיבים את המנה. פורסים את הפרגיות לרצועות. מסדרים בצלחת הגשה לצד הסלט, החמוצים והבצלים. מזלפים מעל הכל טחינה ומפזרים כוסברה, בצל ירוק ופלפל חריף. מגישים מיד. 
                                        </p>
                                    </ul>
                                    <p>ניתן להשתמש בנתחי אוסובוקו מבשר בקר, טלה או לבן.  לא בטוחים מה אתם מעדיפים? התייעצו עם דודי!</p>
                                </div>
                                <div class="col-md-6 col-12">
                                        <img class="img-fluid" src="../assets/img/tale1.png" alt="אוסבוסקו טלה">
                                    </div>
                            </div>
                        </div>
