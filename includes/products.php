...
<body>
    <div class="wrapper recepies">
        ...
        <section>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12 single_portfolio_text">
                                            <a href="product_Page.php?department=meat">
                                            <img src="../assets/img/sinta_egel.png.PNG" alt="" height="600px"/>
                                            <div class="portfolio_images_overlay text-center">
                                            <h6 class="clrd-font">בשרים ועופות</h6>
                                            </a> 
                                            </div>
                                    </div>

                                    <div class="col-md-4 col-sm-6 col-xs-12 single_portfolio_text">
                                            <a href="product_Page.php?department=fish">
                                            <img src="../assets/img/fish.png" alt="" height="600px"/>
                                            <div class="portfolio_images_overlay text-center">
                                            <h6 class="clrd-font">דגים</h6>
                                            </a>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 single_portfolio_text">
                                            <a href="product_Page.php?department=naknikim">
                                            <img src="../assets/img/naknikim.jpg" alt="" height="600px"/>
                                            <div class="portfolio_images_overlay text-center">
                                            <h6 class="clrd-font">נקניקים</h6>
                                            </a>
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12 single_portfolio_text">
                                            <a href="product_Page.php?department=cheese">
                                            <img src="../assets/img/mutzarela_balls.png.PNG" alt="" height="600px"/>
                                            <div class="portfolio_images_overlay text-center">
                                            <h6 class="clrd-font">גבינות</h6>
                                            </a>

                                            </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-xs-12 single_portfolio_text">
                                            <a href="product_Page.php?department=shimurim">
                                            <img src="../assets/img/raw_material.png" alt="" height="600px"/>
                                            <div class="portfolio_images_overlay text-center">
                                            <h6 class="clrd-font"> חומרי גלם לבישול</h6>
                                            </a>
                                            </div>
                                    </div>
                                    <div class="col-md-4 col-sm-6 col-xs-12 single_portfolio_text">
                                            <a href="product_Page.php?department=wine">
                                            <img src="../assets/img/wine.png" alt="" height="600px"/>
                                            <div class="portfolio_images_overlay text-center">
                                            <h6 class="clrd-font">אלכוהול </h6>
                                            </a>
                                            </div>
