...
<body>
    <div class="wrapper recepies">
            <header>
                ...
                <section>
                    <div class="row recepiesHead">
                        <div class="col">
                            <h3>בחרו ממבחר המתכונים שלנו</h3>
                            <p>בתיאבון!</p>
                        </div>
                    </div>
                </section>
        ...
        <section>
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                                            <img src="../assets/img/tale1.png" alt="" />
                                            <div class="portfolio_images_overlay text-center">
                                                <h6 class="clrd-font">אוסובוקו טלה</h6>
                                                <a href="recipe1.php" class="btn btn-primary">למתכון</a>
                                            </div>
                                            <a class="fancybox" rel="ligthbox" href="../assets/img/tale1.jpg">
                                                <div class="zoom"></div>
                                            </a>
                                    </div>

                                    <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                                            <img src="../assets/img/tale2.png" alt="" />
                                            <div class="portfolio_images_overlay text-center">
                                                <h6 class="clrd-font">צלעות טלה מתובל בעשבי תיבול של דודי</h6>
                                                <a href="recipe2.php" class="btn btn-primary">למתכון</a>
                                            </div>
                                            <a class="fancybox" rel="ligthbox" href="../assets/img/tale2.jpg">
                                                <div class="zoom"></div>
                                            </a>
                                    </div>
                                    <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                                            <img src="../assets/img/kinoa.png" alt="" />
                                            <div class="portfolio_images_overlay text-center">
                                                <h6 class="clrd-font">סלט קינואה מלא חלבון</h6>
                                                <a href="recipe3.php" class="btn btn-primary">למתכון</a>
                                            </div>
                                            <a class="fancybox" rel="ligthbox" href="../assets/img/kinoa.jpg">
                                                <div class="zoom"></div>
                                            </a>
                                    </div>
                                    <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                                            <img src="../assets/img/shuarma.png" alt="" />
                                            <div class="portfolio_images_overlay text-center">
                                                <h6 class="clrd-font">סלט שווארמה</h6>
                                                <a href="recipe4.php" class="btn btn-primary">למתכון</a>
                                            </div>
                                            <a class="fancybox" rel="ligthbox" href="../assets/img/shuarma.jpg">
                                                <div class="zoom"></div>
                                            </a>
                                    </div>
                                    <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                                            <img src="../assets/img/caved.png" alt="כבד קצוץ" />
                                            <div class="portfolio_images_overlay text-center">
                                                <h6 class="clrd-font">כבד קצוץ</h6>
                                                <a class="cursor btn btn-primary">למתכון</a>
                                                <p class="text-white font-weight-light">המתכון עוד בעריכה</p>
                                            </div>
                                            <a class="fancybox" rel="ligthbox" href="../assets/img/caved.png">
                                                <div class="zoom"></div>
                                            </a>
                                    </div>
                                    <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                                            <img src="../assets/img/salamon.png" alt="סלמון" />
                                            <div class="portfolio_images_overlay text-center">
                                                <h6 class="clrd-font">סלמון אפוי בתנור</h6>
                                                <a  class="cursor btn btn-primary">למתכון</a>
                                                <p class="text-white font-weight-light">המתכון עוד בעריכה</p>
                                            </div>
                                            <a class="fancybox" rel="ligthbox" href="../assets/img/salamon.png">
                                                <div class="zoom"></div>
                                            </a>
                                    </div>
                                    <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                                            <img src="../assets/img/kornbif.png" alt="" />
                                            <div class="portfolio_images_overlay text-center">
                                                <h6 class="clrd-font">קורנביף</h6>
                                                <a  class="cursor btn btn-primary">למתכון</a>
                                                <p class="text-white font-weight-light">המתכון עוד בעריכה</p>
                                            </div>
                                            <a class="fancybox" rel="ligthbox" href="../assets/img/kornbif.png">
                                                <div class="zoom"></div>
                                            </a>
                                    </div>
                ...
                <div class="row footer">
                    <div class="col-md-4 col-12">
                            <ul class="list-unstyled">
                                    ...
                                    <li><a href="#" class="text-white">מתכונים</a></li>
