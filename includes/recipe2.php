                ...
                <section>
                 <div class="container mt-5 mb-5" dir="rtl">
                        <div class="row recepieHead text-right">
                                ...
                                <div class="col">
                                    <h3>מתכון לצלעות טלה מתובל בעשבי תיבול של דודי</h3>
                                    <p>בתיאבון!</p>
                        ...
                        <div class="container recepieCon mb-5" dir="rtl">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12 text-right">
                                    <ul >
                                        <li>מחממים תנור ל-180 מעלות טורבו למשך חצי שעה</li>
                                        <li>מוציאים את נתח הצלעות לטמפ׳ החדר למשך חצי שעה. </li>
                                        <li>מנמיכים את טמפ׳ התנור ל150 ללא טורבו. </li>
                                        <li>מכניסים את הנתח לתנור למשך 45 דקות לכדי רמת צלייה Medium 
                                                המלצת הגשה – לצד ירקות שורש ויין אדום עמוק. </li>
                                    </ul>
                                   
                                </div>
                                <div class="col-md-6 col-12">
                                        <img class="img-fluid" src="../assets/img/tale2.png" alt="אוסבוסקו טלה">
                                    </div>
                            </div>
                        </div>
