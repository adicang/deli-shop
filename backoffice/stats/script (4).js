			...
			var areaChart = new Chart(ctx, {
				...
				data: {
					...
					datasets: [{
						label: "הכנסות",
						lineTension: 0.3,
						backgroundColor: "#4E9B39",
						borderColor: "#00632b",
						pointRadius: 3,
						pointBackgroundColor: "#00632b",
						pointBorderColor: "#4E9B39",
						pointHoverRadius: 3,
...
function getMonthlyOrders() {
	...
	$.ajax({
		...
		dataType: "JSON",
		success: function (data) {
			if (data[0].orders !== null) {
				monthlyCst = data[0];
				console.log(monthlyCst);
			}
...
function getInStock(){
    ...
    request.onreadystatechange=function(){
        if (request.readyState==4 & request.status==200){
            ...
            document.getElementById("amount_to_fill").value=myObj.code;
            
        }
    }
  
    request.open("POST",'../includes/get_amount_in_stock.php',true);
